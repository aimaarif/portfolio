      ...
      <div className="h-72 overflow-y-hidden">
        <div className="flex h-full flex-col gap-10 translate-y-16 group-hover:translate-y-12 transition-transform duration-500">
          {/* <div className="w-10 h-8 flex flex-col justify-between" >
            ...
            {icon ? (
              <span className="text-5xl text-designColor" style={{color:'rgb(0, 200, 235)'}}>{icon}</span>
            ) : (
                <>
          ...
          <div className="flex flex-col gap-6">
            <h2 className="text-xl md:text-2xl font-titleFont font-bold text-gray-300" style={{color:'rgb(0, 200, 235)'}} >
              {title}
            </h2>
            <p className="base">{des}</p>
            {/* <span className="text-2xl text-designColor" style={{color:'rgb(0, 200, 235)'}}>
              <HiArrowRight />
            </span> */}
          </div>
        </div>
